        ...
        <div className='flex bg-[#04111d] justify-between items-center py-4 px-6 lg:px-12 h-24'>
            ...
            <div className='flex items-center justify-between text-white lg:w-[75vw]'>
                <div className='flex items-center'>
                    <div className='rounded-l-md lg:pl-6 pr-2 h-14 flex items-center text-3xl lg:bg-white lg:bg-opacity-10'>
                        <BiSearch />
                    </div>
                    <input type='text' className='rounded-r-md text-lg outline-none w-0 lg:w-[40rem] bg-white bg-opacity-10 lg:px-4 h-14' placeholder='Search items,collections, and accounts...' />
                </div>
