        ...
        <div className='flex justify-between p-4 lg:p-0 h-24'>
            ...
            <div className='flex items-center text-white'>
                ...
                <div className={`flex 2xl:ml-4 items-start 2xl:items-center  flex-col duration-300 lg:flex-row absolute lg:static inset-0 2xl:inset-auto	bg-gray-800 2xl:bg-transparent z-50 mt-24 2xl:mt-0 font-semibold ${openContentStyle}`}>
                    <Link href=""><a onClick={isClicked} className='my-2 2xl:my-0 2xl:hover:bg-white 2xl:hover:bg-opacity-5 2xl:bg-transparent p-6 hover:mx-2 lg:hover:mx-0 lg:hover:opacity-50 duration-300 text-xl'> Explore </a></Link>
                    <Link href=""><a onClick={isClicked} className='my-2 2xl:my-0 2xl:hover:bg-white 2xl:hover:bg-opacity-5 2xl:bg-transparent p-6 hover:mx-2 lg:hover:mx-0 lg:hover:opacity-50 duration-300 text-xl'> Stats </a></Link>
                    <Link href=""><a onClick={isClicked} className='my-2 2xl:my-0 2xl:hover:bg-white 2xl:hover:bg-opacity-5 2xl:bg-transparent p-6 hover:mx-2 lg:hover:mx-0 lg:hover:opacity-50 duration-300 text-xl'> Resources </a></Link>
                    <Link href=""><a onClick={isClicked} className='my-2 2xl:my-0 2xl:hover:bg-white 2xl:hover:bg-opacity-5 2xl:bg-transparent p-6 hover:mx-2 lg:hover:mx-0 lg:hover:opacity-50 duration-300 text-xl'> Create </a></Link>
                    <div className='flex my-2 absolute 2xl:static bottom-0 2xl:bottom-auto 2xl:ml-4 justify-center items-center w-screen lg:w-auto'>
